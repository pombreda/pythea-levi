...
(function($){
    $.fn.collapser= function(options, beforeCallback, afterCallback) {
		...
		function hideElement(obj, method){
			...
			if(method == 1){
				obj[options.target](options.targetOnly)[effectHide](callback=callAfterCallback);
				obj.html(expHtml);
		...
		function showElement(obj, method){
			callBeforeCallback(obj)
			if(method == 1){
				obj[options.target](options.targetOnly)[effectShow](callback=callAfterCallback);
				obj.html(collHtml);
